...
export function StudioSidebar({
  ...
  return (
    <motion.aside
      ...
      className="h-fit rounded-lg border border-white/10 bg-black p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] will-change-transform lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:h-dvh lg:w-56 lg:rounded-none lg:border-y-0 lg:border-l-0 lg:border-r lg:p-4 lg:pb-6 lg:pt-24"
